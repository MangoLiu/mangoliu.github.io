...
数据挖掘则透过事件的表象发现隐藏在背后的蛛丝马迹，
从而找到潜伏的规律以及看似无关事物之间背后的联系。
```
...
数据分析和业务部门的团队。如果缺少"translators"，
即使拥有高端的数据分析策略和工具方法也是于事无补的。


西北大学工程学院下成立一个主攻大数据分析课程的分析学研究生院并这样解释：
"虽然只要具备一些Hadoop和Cassandra的基本知识就很容易找到工作，
但拥有深入知识的人才却是十分缺乏的。"
此外，该研究生院的课程计划以"传授和指导将业务引向成功的技能，
培养能够领导项目团队的优秀分析师"为目标，
...
其他，以下任选两门（社交网络、文本分析、Web分析、财务分析、服务业中的分析、
能源、健康医疗、供应链管理、综合营销沟通中的概率模型）
